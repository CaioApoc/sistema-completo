...
export default function Profile() {
  ...
  async function handleSave(evento){
            ...
            <form className="form-profile" onSubmit={handleSave}>
              <label className="label-avatar">
                 ...
                 <input type="file" accept="image/*" onChange={handleFile}/> <br/>
                    {avatarUrl === null ?
                    <img src={avatar} width="250" height="250"  alt="foto do perfil do usuario" />
                  :
                   <img src={avatarUrl} width="250" height="250"  alt="foto do perfil do usuario" />}
              </label>
